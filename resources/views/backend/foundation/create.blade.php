            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Foundation</h4>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="post" action="{{route('store.foundation')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Submit for Review">
                                    </div>
                                </form>
