                                        ...
                                        @foreach($activities as $item)
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    ...
                                                    <a href="{{route('edit.activities',$item->id)}}"  class="btn btn-info" title="View & Edit Activity"><i class="fa fa-pencil"></i></a>
                                                    <a href="{{route('delete.activity',$item->id)}}" id="delete" class="btn btn-danger" title="Delete Activity"><i class="fa fa-trash"></i></a>
